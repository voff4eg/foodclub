...
$APPLICATION->SetPageProperty("title", $arUser['FULLNAME']." &mdash; отзывы пользователя на Foodclub");
...
<div id="content">
	...
	<?
	$APPLICATION->IncludeComponent("custom:profile.opinions", "", array("USER"=>$arUser));
	?>	
	</div>
	<div id="banner_space">
