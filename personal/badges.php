...
$APPLICATION->SetPageProperty("title", $arUser['FULLNAME']." &mdash; бейджи пользователя на Foodclub");
?>
<div id="content">
	...
	<div id="text_space">
	<?
	$APPLICATION->IncludeComponent("custom:profile.badges", "list", array("USER"=>$arUser,"URL"=>"/profile/".$arUser["ID"]."/badges/"));
	?>
	</div>
	<div id="banner_space">
		<?
