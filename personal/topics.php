...
$APPLICATION->SetPageProperty("title", $arUser['FULLNAME']." &mdash; записи пользователя на Foodclub");
?>
...
<div id="content">
	...
	<?
	$APPLICATION->IncludeComponent("custom:profile.topics", "", array("USER"=>$arUser));
	?>
	</div>
	<div id="banner_space">
