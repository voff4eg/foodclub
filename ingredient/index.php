...
$APPLICATION->SetPageProperty("description", "Кабачок — кустовая разновидность тыквы. Он имеет вид продолговатых плодов, без плетей. Сами плоды могут быть как белого цвета, так и зеленого, желтого, и даже черного.");
$APPLICATION->SetPageProperty("keywords", "кабачки рецепты, рецепты из кабачков, рецепты с кабачками, кабачки рецепты фото, кабачки рецепты с фото, рецепты блюд кабачки,");
$APPLICATION->SetTitle("Рецепты из кабачков");
