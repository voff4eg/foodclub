...
<li>
	...
	<?if(strlen($arItem["PERSONAL_PHOTO"]) > 0):?><a class="icon" href="/profile/<?=$arItem['ID']?>/"><img width="50" height="50" alt="<?=$name?>" src="<?=CFile::GetPath($arItem["PERSONAL_PHOTO"])?>"></a><?else:?><a class="icon" href="/profile/<?=$arItem['ID']?>/"><img width="50" height="50" alt="<?=$arItem["LOGIN"]?>" src="/images/avatar/avatar.jpg"></a><?endif;?>
