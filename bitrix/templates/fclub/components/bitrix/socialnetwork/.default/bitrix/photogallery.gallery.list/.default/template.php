...
?><div class="photo-user<?=($arParams["USER_ID"] == $GLOBALS["USER"]->GetId() ? " photo-user-my" : "")?>"><?
...
?><div class="photo-controls photo-action"><?
	?><a href="<?=$arResult["LINK"]["NEW"]?>" title="<?=GetMessage("P_GALLERY_CREATE_TITLE")?>"  class="photo-action gallery-new" <?
...
?><table width="100%" cellpadding="0" cellspacing="0" border="0" class="photo-gallery <?=($res["UF_DEFAULT"] == "Y" ? " gallery-active" : "")?><?=
	(empty($res["CODE"]) ? " gallery-error-code" : "")?>" title="<?=($res["UF_DEFAULT"] == "Y" ? GetMessage("P_GALLERY_ACTIVE") : "").(empty($res["CODE"]) ? ($res["UF_DEFAULT"] == "Y" ? ".\n" : "").GetMessage("P_ERROR_CODE") : "")?>"><?
?><tr><td width="1%"><?
		...
		?><table cellpadding="0" cellspacing="0" class="shadow"><?
			?><tr class="t"><td colspan="2" rowspan="2"><?
				?><div class="outer" style="width:<?=($arParams["GALLERY_AVATAR_SIZE"] + 32)?>px;"><?
					...
					?><div class="inner"><a href="<?=$res["LINK"]["VIEW"]?>" title="<?=
