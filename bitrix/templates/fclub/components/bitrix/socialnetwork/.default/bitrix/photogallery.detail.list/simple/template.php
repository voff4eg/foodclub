...
?>
					<td class="star-voted"><div class="star-voted" title="<?=$name?>"></div></td>
<?
				else:
?>
					<td class="star-empty"><div class="star-empty" title="<?=$name?>"></div></td>
<?
				endif;
			endforeach;
?>
...
?>
						<?=GetMessage("T_IBLOCK_VOTE_RESULTS", 
							array(
								"#VOTES#"=>$arItem["PROPERTIES"]["vote_count"]["VALUE"] , 
