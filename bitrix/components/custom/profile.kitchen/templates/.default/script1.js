...
function kitchenAdminButtons() {
	...
	function clickEdit() {
		...
		var data = getData();
		openAddForm();
		$(".b-kitchen__add-form").data("KitchenAddForm").fillForm(data).changeTitle("Редактировать технику");
