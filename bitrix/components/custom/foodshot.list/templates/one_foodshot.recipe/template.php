...
<?$APPLICATION->AddHeadScript("/bitrix/components/custom/foodshot.list/templates/one_foodshot/static/script.js");?>
<?$frame = $this->createFrame()->begin('<img src="/images/preloader.gif" width="100%" alt="">');?>
<link href="/foodshot/foodshot.css?135037931126808" type="text/css"  rel="stylesheet" />
<div id="b-last-foodshot">
<?if(!empty($arResult["ITEMS"])):?>
<div class="b-last-foodshot">
	<? 
	//$frame = $this->createFrame("script",false)->begin();
	...
	<h5><a href="/foodshot/#!foodshot">Свежий фудшот</a></h5>
	...
	<?foreach($arResult["ITEMS"] as $arItem):?>
		...
		<div data-id="<?=$arItem["ID"]?>" class="b-foodshot-board__item b-foodshot-board__item__type_static" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		  ...
		  <div class="b-foodshot-board__item-content">
		    ...
		    <?endif;?>
		  <div class="b-foodshot-board__item-action" id="b-foodshot_<?=$arItem["ID"]?>">
			<?if($USER->IsAuthorized()):?>
