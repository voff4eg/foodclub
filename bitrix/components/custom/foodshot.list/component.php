...
if($this->StartResultCache(false, array(($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()), $auth, $USER->GetID(), $bUSER_HAVE_ACCESS, $arNavigation, $arrFilter,"@#")))
{
	...
	if($arResult = $rsIBlock->GetNext())
	{
		...
		while($obElement = $rsElement->GetNextElement())
		{
			...
			$arItem["PREVIEW_TEXT"] = str_replace("<a", "<a rel='nofollow'", $arItem["PREVIEW_TEXT"]);			
