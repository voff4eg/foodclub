...
{
    $APPLICATION->SetTitle("Кулинары", $arTitleOptions);
}
	...
	if($arResult = $rsIBlock->GetNext())
	{
		...
		if(!array_key_exists("ID", $arSort))
			$arSort["ID"] = "DESC";
                ...
                $ordr = "desc";
                $UserCount = 21;
                $dbUsers = $cUser->GetList($by_sort, $ordr, $arFilter,array("SELECT"=>array("UF_*"),"NAV_PARAMS"=>array("nPageSize"=>"{$UserCount}")));
                ...
                $arResult["USERS"]["USERS_COUNT"] = $UserCount;
