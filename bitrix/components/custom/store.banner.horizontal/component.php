...
if (CModule::IncludeModule("advertising")){
	...
	$banner2 = CAdvBanner::Show("store_horizontal");
	$banner3 = CAdvBanner::Show("store_horizontal");
	$banner4 = CAdvBanner::Show("store_horizontal");
	$arResult["banner"] = $banner1.$banner2.$banner3.$banner4;
