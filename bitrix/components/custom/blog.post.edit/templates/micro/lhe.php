...
if(CModule::IncludeModule("fileman"))
{
	...
	function CustomizeLightEditorForBlog()
	{
		...
		{
			var str = 
				'<span class="errortext" id="lhed_blog_image_error"></span>' +
				'<table width="100%"><tr>' +
				'<td class="lhe-dialog-label lhe-label-imp"><?= GetMessage('BLOG_IMAGE')?>:</td>' +
				'<td class="lhe-dialog-param">' +
				'<form id="' + pObj.pLEditor.id + 'img_upload_form" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data" style="margin: 0!important; padding: 0!important;">' +
				'<?=bitrix_sessid_post()?>' +
