...
//				oCell.vAlign = 'top';
	...
	else
	{
		...
		?>
		<form action="<?=POST_FORM_ACTION_URI?>" name="REPLIER" method="post" enctype="multipart/form-data" onmouseover="check_ctrl_enter" id="add_post_form">
		<?=bitrix_sessid_post();?>
			<h2 style="padding-bottom: 20px;">Добавление записи</h2>
			<table class="blog-blog-edit" id="main_table">
			<tr>
				<th><?=GetMessage("BLOG_TITLE")?></th>
				<td>
					<h5>Тема</h5>
					<input tabindex="1" type="text" name="POST_TITLE" value="<?=$arResult["PostToShow"]["TITLE"]?>" class="text">
				</td>
			</tr>
			<tr id="tr_TEXT">
				<th><?=GetMessage("BLOG_TEXT")?></th>
				<td class="blog-detail-text">
					...
					<div id="edit-post-text" style="display:none;">
						...
						<tr>
							<td colspan="2">
								...
								<tr>
									...
									<td>
										<a id="FontColor" class="blogButton" href="javascript:ColorPicker()"><img class="blogButton" src="<?=$templateFolder?>/images/font_color.gif" width="15" height="13" title="<?echo GetMessage("FPF_IMAGE")?>"></a>
										<a class="blogButton bold_button" href="javascript:simpletag('B')" title="<?echo GetMessage("FPF_BOLD")?>">Ж</a>
										<a class="blogButton italic_button" href="javascript:simpletag('I')" title="<?echo GetMessage("FPF_ITALIC")?>">К</a>
										<a class="blogButton under_button" href="javascript:simpletag('U')" title="<?echo GetMessage("FPF_UNDER")?>">Ч</a>
										<a class="blogButton mdash_button" href="javascript:void(0)" onclick="doInsert('—', '', false)" title="Длинное тире">&mdash;</a>
										<a class="blogButton quot_button" href="javascript:simpletag('quots')" title="Кавычки">&laquo;&nbsp;&raquo;</a>
										
										<a class="blogButton" href="javascript:tag_url()"><img class="blogButton" src="<?=$templateFolder?>/images/link.gif" width="15" height="13" title="<?echo GetMessage("FPF_HYPERLINK")?>"></a>
										<!--//<a class="blogButton" href="javascript:tag_image()"><img class="blogButton" src="<?=$templateFolder?>/images/image_link.gif" width="15" height="13" title="<?=GetMessage("BLOG_P_IMAGE_LINK")?>" id="image-link"></a>-->
										<a class="blogButton" href="javascript:ShowImageUpload()"><img class="blogButton" src="<?=$templateFolder?>/images/image.gif" width="15" height="13" title="<?=GetMessage("BLOG_P_DO_UPLOAD")?>" id="image-upload"></a>
										<a class="blogButton" href="javascript:ShowVideoInput()"><img class="blogButton" src="<?=$templateFolder?>/images/video.gif" width="15" height="13" title="<?=GetMessage("FPF_VIDEO")?>" id="videoImg"></a>
										...
										<a class="blogButton" href="javascript:void(0)" onclick="doInsert('[CUT]', '', false)"><img class="blogButton" src="<?=$templateFolder?>/images/cut.gif" width="15" height="13" title="<?echo GetMessage("FPF_CUT")?>" id="cutImg"></a>
									</td>
						...
						<tr>
							<td width="100%"><textarea tabindex="2" name="POST_MESSAGE" cols="15" rows="15" id="MESSAGE" onKeyPress="check_ctrl_enter(arguments[0])"><?=$arResult["PostToShow"]["DETAIL_TEXT"]?></textarea></td>
							<td valign="middle">
			...
			if (!empty($arResult["Images"]))
			{
				?>
				<tr>
					<th><?=GetMessage("BLOG_P_IMAGES")?></th>
					<td>
						...
						foreach($arResult["Images"] as $aImg)
						{
							...
							?>
								<td>
									<table class="delete_img"><tr><td><input type="checkbox" name="IMAGE_ID_del[<?=$aImg["ID"]?>]" id="img_del_<?=$aImg["ID"]?>"></td><td><label for="img_del_<?=$aImg["ID"]?>"><?=GetMessage("BLOG_DELETE")?></label></td></tr></table>
									<?=$aImg["FileShow"]?><br />
									<input name="IMAGE_ID_title[<?=$aImg["ID"]?>]" value="<?=$aImg["TITLE"]?>" class="text" title="<?=GetMessage("BLOG_BLOG_IN_IMAGES_TITLE")?>"><br />
								</td>
							<?
							if($i == 3)
							{
			...
			<tr>
				<th><?=GetMessage("BLOG_CATEGORY")?></th>
				<td>
					<h5>Метки</h5>
					<?/*
					...
					*/?>
					<div id="category-new">
						...
						{
							?><input type="text" name="TAGS" value="" class="text">
							<?
						}?>
			...
			<tr id="public_date">
				<th><?=GetMessage("BLOG_DATE_PUBLISH")?></th>
				<td>
			...
			{
				?>
				<tr id="adress_trackback">
					<th valign="top" align="right" nowrap><b><?=GetMessage("BLOG_ADDRESSES")?></b></th>
					<td><textarea name="TRACKBACK" cols="15" rows="5"><?=$arResult["PostToShow"]["TRACKBACK"]?></textarea></tr>
				<tr id="adress_trackback">
			...
			<input tabindex="3" type="hidden" name="save" value="Написать"><!--//<?=GetMessage("BLOG_SAVE")?>
