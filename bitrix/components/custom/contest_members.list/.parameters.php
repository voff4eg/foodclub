...
$rsContests = CIBlockElement::GetList(array("NAME"=>"ASC"),array("IBLOCK_ID"=>15),false,false,array("ID","NAME"));
while($arContests = $rsContests -> GetNext()){
	$Contests[ $arContests["ID"] ] = $arContests["NAME"];
}
