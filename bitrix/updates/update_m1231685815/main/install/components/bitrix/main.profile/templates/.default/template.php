...
<table class="profile-table data-table">
	...
	<tr>
		...
		<td><input type="password" name="NEW_PASSWORD" maxlength="50" value="" /></td>
	</tr>
	<tr>
		<td><?=GetMessage('NEW_PASSWORD_CONFIRM')?></td>
		<td><input type="password" name="NEW_PASSWORD_CONFIRM" maxlength="50" value="" /></td>
	</tr>
	</tbody>
</table>
</div>
...
<table class="data-table profile-table">
	...
	<tbody>
		...
		<tr>
			...
			<td><textarea cols="30" rows="5" name="WORK_PROFILE" cols="40" rows="5"><?=$arResult["arUser"]["WORK_PROFILE"]?></textarea></td>
		</tr>
		<tr>
...
<table class="data-table profile-table">
	...
	<tbody>
		...
		<tr>
			...
			<td><textarea cols="30" rows="5" name="forum_INTERESTS" rows="3" cols="35"><?=$arResult["arForumUser"]["INTERESTS"]; ?></textarea></td>
		</tr>
		<tr>
			<td><?=GetMessage("forum_SIGNATURE")?></td>
			<td><textarea cols="30" rows="5" name="forum_SIGNATURE" rows="3" cols="35"><?=$arResult["arForumUser"]["SIGNATURE"]; ?></textarea></td>
		</tr>
		<tr>
