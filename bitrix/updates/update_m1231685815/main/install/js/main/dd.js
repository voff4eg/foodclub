jsDD = {
	...
	drag: function(e)
	{
		...
		var current_dest_index = jsDD.searchDest(jsDD.x, jsDD.y);
	...
	stopDrag: function(e)
	{
		...
		if (jsDD.bStarted)
		{
			...
			dest_index = jsDD.searchDest(jsDD.x, jsDD.y);
			if (false !== dest_index)
			{
				if (null != jsDD.arDestinations[dest_index].onbxdestdragfinish)
				{
					if (!jsDD.arDestinations[dest_index].onbxdestdragfinish(jsDD.current_node, jsDD.x, jsDD.y))
						dest_index = false;
					else
					{
