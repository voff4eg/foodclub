...
$obRecipe = $rsRecipe->GetNextElement();
...
//echo "<pre>"; print_r($arProp['recipt_steps']['VALUE']); echo "</pre>";
?>
<div id="content">
<form name="dish" action="/admin/recipe/edit/post/" method="post" enctype="multipart/form-data">
					...
					<div class="stage">
						...
						<div class="ingredient">
							...
							foreach($arResult as $strKey => $arItem):?>
								<li><span class="name"><?=$arItem['NAME']?></span><input class="text" name="ingredients_<?=$strMKey?>_number[]" value="<?=$arItem['VALUE']?>" type="text"><input name="ingredients_<?=$strMKey?>_id[]" value="<?=$arItem['ID']?>" type="hidden"><span class="unit"><?=$arItem['UNIT']?></span><span class="no_text">?</span></li>
								<?
