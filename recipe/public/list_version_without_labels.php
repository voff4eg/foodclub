...
<div class="item recipe_list_item">
	...
	<p class="info"><span title="Оставить отзыв" class="comments_icon"><noindex><a href="{$site_dir}detail/{$arRecipe['ID']}/#comments">12</a></noindex></span></p>
</div>
HTML;
			}
		}
		...
		<div id="filter_recipes">
			<div class="item cuisine">
				...
				<a class="frame_bg" href="#">
					<span class="left">
						<span class="right">
							<span class="bg"><span>&mdash;</span></span>
						</span>
					</span>
